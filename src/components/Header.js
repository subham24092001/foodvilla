...
const Header = () => {
  ...
  return (
    <div className='w-full h-20 top-0 flex justify-between items-center sticky shadow-lg bg-white z-[1001]'>
      <div className='ml-6 sm:ml-10 md:ml-20 flex items-center'>
        <Link to='/'>
      ...
      <ul className='hidden sm:flex'>
        <li className='sm:mr-7 group hover:text-orange-500 mr-14 '>
          <Link
            ...
            <svg
              className='group-hover:fill-orange-500 stroke-current stroke-0'
              viewBox='5 -1 12 25'
              height='17'
              width='17'
              fill='#686b78'>
        ...
        <li className='sm:mr-7 md:flex group hover:text-orange-500 mr-14'>
          <Link
            ...
            className='flex items-center justify-center gap-2 font-medium text-base'>
            <svg
              className='stroke-current stroke-0 group-hover:fill-orange-500'
              viewBox='6 -1 12 25'
              height='19'
              width='19'
              fill='#686b78'>
        ...
        <Link to="/Sign In">
          <li
            className='sm:mr-7 md:mr-12 group hover:text-orange-500'>
            <div
              className='flex gap-1 relative items-center pl-7 font-medium text-base'>
              <span
                className='absolute top-1/2 left-0 -translate-y-1/2'>
                <svg
                  className='fill-[#3d4152] stroke-current stroke-0 relative group-hover:fill-orange-500'
                  viewBox="6 0 12 24"
                  height="19"
                  width="18"
                  fill="#686b78">
        ...
        <li data-testid='cart'
          className='sm:mr-7 md:mr-24 lg:mr-32 flex gap-1 relative items-center pl-7 font-medium text-base group hover:text-orange-500'>
          <Link
            to='/cart'>
            <span
              className='absolute top-1/2 left-0 -translate-y-1/2'>
              <svg
                className='fill-white stroke-[#282c3f] relative stroke-2 group-hover:stroke-orange-500'
                viewBox="-1 0 37 32"
                height="20"
                width="20"
                fill="#686b78">
      ...
      <div className='sm:hidden relative flex'>
        <li data-testid='cart'
          className='mr-2 sm:mr-7 md:mr-24 lg:mr-32 flex gap-1 relative items-center pl-7 font-medium text-base group hover:text-orange-500'>
          <Link
            to='/cart'>
            <span
              className='absolute top-1/2 left-0 -translate-y-1/2'>
